...
public class ContaServlet extends HttpServlet {
	...
	private void addTrans(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			SendMsg.send(req, res, "Transação inserida com sucesso.", "append/contaPost.jsp?action=trans");
		} catch (ParseException e) {
			SendMsg.send(req, res, "Erro ao inserir transação.", "append/contaPost.jsp?action=trans");
		}
	}
