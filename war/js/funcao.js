$(document).ready(function() {
	$("#lista").find("li").each(function(i) {
		$(this).click(function(e){
			...
			var descricao = $.post("/modelos", { id: idModelo} );
	...
	$('.botao').click(function(e){
		...
		// $('#popUp').css({top:alturaJanela/2
		// -260/2,left:largura/2 - 434/2});
		// $('#nomePopUp').text(modelo);
		// $('#PopUp p').text(descricao);
		// $('#valor').val( idModelo);
	...
	$(".armazenar").click(function(e){
		...
		// $("#popUpInserir
		// textarea").val(nomeModelo +
		// enderecoModelo+descricaoModelo );
		$('#tudo').html(pagina);
