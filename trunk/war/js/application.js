var Application =  {
  ...
  evalCode: function(id) {
	...
	insertNavigation: function(selected) {
	  document.write('\
	  <h1><a href="http://prototype-window.xilinus.com"><img border=0 src="js/pwc.gif"/></a></h1>\
    <div class="navigation">\
      <ul>\
        <li><a id="menu_documentation" href="js/documentation.html">Documentation</a></li>\
        <li><a id="menu_samples" href="js/samples.html">Samples</a></li>\
        <li><a id="menu_debug" href="js/debug.html">Debug</a></li>\
        <li><a id="menu_themes" href="js/themes.html">Themes</a></li>\
      </ul>\
    </div>');
